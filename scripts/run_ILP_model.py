...
""" Implements a pipeline for tracking microtubules.

The input to the pipeline are microtubules candidates. Candidates are linked by solving an Integer Linear Programing.
For more information, see:
Buhmann, Julia M., et al.
"Tracking of microtubules in anisotropic volumes of neural tissue."
2016 IEEE 13th International Symposium on Biomedical Imaging (ISBI). IEEE, 2016.
"""
...
def main():
    ...
    parser.add_argument('-distance_cost', type=float, default=1.0,
                        help='ILP hyperparameter: theta_D in the paper, cost for the edge distance. If this value is '
    ...
    parser.add_argument('-comb_angle_cost', type=float, default=5.0,
                        help='ILP hyperparameter. theta_C in the paper, cost for rigidity. If this value is high, '
    ...
    parser.add_argument('-angle_cost_factor', type=float, default=0.0,
                        help='ILP hyperparameter: theta_a in the paper, cost for the discrepancy of estimated '
    ...
    parser.add_argument('-selection_cost', type=float, default=-50.0,
                        help='ILP hyperparameter: theta_V in the paper, cost for the selection of a candidate.')
